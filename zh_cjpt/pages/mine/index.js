...
Page({
    ...
    formSubmit: function(e) {
        ...
        "" == n ? h = "请输入您的真实名字" : "" == s && 1 == t.is_dxyz ? h = "请输入您的真实手机号" : null == s && 2 == t.is_dxyz ? h = "请输入您的真实手机号" : "" == i ? h = "请输入您的邮箱账号" : /^\w+@[a-zA-Z0-9]{2,10}(?:\.[a-z]{2,4}){1,3}$/.test(i) ? "" == u ? h = "请输入验证码" : "" == l ? h = "请输入登录密码" : "" == c ? h = "请再次输入登录密码" : u != m && 1 == t.is_dxyz ? h = "验证码输入错误" : l != c ? h = "登录密码输入不一致" : 0 == f && (h = "请阅读并同意入驻申请协议") : h = "请输入正确的邮箱", 
