...
Page({
    ...
    order_list: function(t) {
        var e = this, a = e.data, o = a.state, n = a.page, s = a.qs_id, r = a.list, i = a.distaceShop, c = a.location.split(",");
        console.log(i), console.log("当前的page为" + n + " 当前的状态值为" + o + " 骑手的id为" + s), app.util.request({
            ...
            success: function(t) {
                if (console.log(t), 0 < t.data.length) {
                    for (var a in t.data) t.data[a].distance = app.location(Number(c[0]), Number(t.data[a].sender_lat), Number(c[1]), Number(t.data[a].sender_lng)), 
                    ...
                    t.data[a].time = app.ormatDate(t.data[a].time), t.data[a].distance <= i && (r = r.concat(t.data[a]));
                    e.setData({
                        list: r,
                        page: n + 1
                    });
